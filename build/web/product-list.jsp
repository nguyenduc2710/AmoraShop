                ...
                <c:forEach items="${requestScope.products}" var="product">
                    <form action="MainController">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="pQuantity" value="${product.quantity}"/>
                            </td>
                            <td 
                                style="padding-left: 20px">
                                <input type="text" name="pStatus" value="${product.status}"/>
                            </td>
                            <td 
                                style="padding-left: 20px">
                                <input type="text" name="pDescrip" value="${product.description}"/> 
                            </td>
                            <td> 
                                <input type="text" name="pCapacity" value="${product.capacity}"/> 
                            </td>
                            <td>
                                <input type="text" name="pBrand" value="${product.brand}"/> 
                            </td>
                            <td 
                                style="padding-left: 20px">
                            ...
                            <td 
                                style="padding-left: 20px">
                                <input type="text" name="pCategory" value="${product.categoryID}"/>
                            </td>
                            <td>
                                <!--delete-->
